...
class LlamaConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        visual_full_available=False,
        enable_ms_poe=False,
        apply_layers=[],
        head_type=None,
        compress_ratio_min=1.2,
        compress_ratio_max=1.8,
        fast_v_sys_length=None, # enable the usage of fast_v
        ...
        **kwargs,
        ...
        self.enable_mda_attention = enable_mda_attention
        self.visual_full_available = visual_full_available
        self.enable_ms_poe = enable_ms_poe
        self.apply_layers = apply_layers
        self.head_type = head_type
        self.compress_ratio_min = compress_ratio_min
        self.compress_ratio_max = compress_ratio_max
