...
declare -a temperatures=("0.0")  
declare -a eval_types=("greedy")  

for i in "${!temperatures[@]}"; do  
    temperature="${temperatures[$i]}"  
    EVAL_TYPE="${eval_types[$i]}"  
    
    EXPERIMENT_NAME="${EXPERIMENT}_${EVAL_TYPE}"  
    #################################################################################################################
    # echo "${EXPERIMENT_NAME} Running with temperature=${temperature} and EVAL_TYPE=${EVAL_TYPE} in LLavaBench"  
    ...
    echo "${EXPERIMENT_NAME} Running with temperature=${temperature} and EVAL_TYPE=${EVAL_TYPE} in MMVET"  
    python -m llava.eval.model_vqa \
        --model-path "$MODEL" \
    ...
    echo "${EXPERIMENT_NAME} Running with temperature=${temperature} and EVAL_TYPE=${EVAL_TYPE} in TEXTVQA without OCR Context"  
